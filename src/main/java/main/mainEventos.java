/*
 * Se crean 7 prendas (con sus tipos, colores, materiales, etc) Se crea un
 * usuario gratuito con 2 guardarropas Se le agregan distintas prendas a los
 * guardarropas Se crea un evento ahora mismo y el programa muestra una
 * sugerencia Actualmente la sugerencia no devuelve ninguna combinacion de
 * prendas
 * 
 * 
 * package main;
 * 
 * import java.time.LocalDate; //import java.time.format.*; // Este paquete
 * contiene DateTimeFormatter import java.util.HashSet; import java.util.Set;
 * 
 * import componentes.Categoria; import componentes.Color; import
 * componentes.Material; import componentes.Prenda; import
 * componentes.PrendaNivel; import componentes.TipoDePrenda; import
 * componentes.Trama; import eventos.Evento; import guardarropas.Guardarropa;
 * import usuario.CuentaGratuita; import usuario.Usuario;
 * 
 * public class mainEventos {
 * 
 * public static void main(String[] args) throws Exception {
 * 
 * //Cargamos usuarios, prendas, colores, etc Set <Material>
 * tiposDeMaterialRemera; Set <Material> tiposDeMaterialZapato; Set <Material>
 * tiposDeMaterialZapatilla; Set <Material> tiposDeMaterialPantalon; Set
 * <Material> tiposDeMaterialLentes;
 * 
 ...
 * colorNegro; Prenda unaRemeraBlancaLisa; Prenda unaRemeraRoja; Prenda
 * unaRemeraNegra; Prenda unPantalonNegro; Prenda unZapatoNegro; Prenda
 * unaZapatillaLonaBlanca; Prenda unLenteNegro; Guardarropa guardarropaInesUno;
 * Guardarropa guardarropaInesDos; // tiposDeMaterialRemera = new
 ...
 * 
 * 
 * colorBlanco=new Color(255,255,0); colorNegro=new Color(10,10,10);
 ...
 * 
 * ines.setTipoDeCuenta(new CuentaGratuita()); ines.setNombre("Ines Gonzalez");
 ...
 * 
 * 
 * //Cargamos algunos eventos ines.cargarEvento( LocalDate.now(), "Ir al cine",
 * 3433955); Evento unEvento= new Evento ( LocalDate.now(), "Ir al cine", ines,
 * 3433955); //ines.procesarEvento(unEvento);
 ...
 * ines.cargarEvento( LocalDate.of(2019, 8, 14), "Cumpleaños de Pepita",
 * 3433955);
 * 
 * 
 * 
